...
///
/// ```rust,ignore
/// use shopify_sdk::rest::resources::v2026_04::{Collection, CustomCollection};
///
...
pub trait Collection: Send + Sync {
    ...
    ///
    /// ```rust,ignore
    /// use shopify_sdk::rest::resources::v2026_04::{Collection, CustomCollection, ProductListParams};
    ///
    /// let collection = CustomCollection::find(&client, 123, None).await?.into_inner();
    ///
    /// // Get all products
    ...
    ///
    /// ```rust,ignore
    /// use shopify_sdk::rest::resources::v2026_04::{Collection, SmartCollection};
    ///
