...
//! use shopify_sdk::rest::resources::v2026_04::common::{WebhookTopic, WebhookFormat};
//!
...
mod tests {
    ...
    fn test_webhook_struct_serialization() {
        let webhook = Webhook {
            ...
            topic: Some(WebhookTopic::OrdersCreate),
            format: Some(WebhookFormat::Json),
            api_version: Some("2026-04".to_string()),
        ...
        assert_eq!(parsed["api_version"], "2026-04");
    ...
    fn test_webhook_deserialization_from_api_response() {
        ...
        assert_eq!(webhook.api_version, Some("2026-04".to_string()));
        assert_eq!(
            webhook.fields,
            Some(vec![
                "id".to_string(),
